...
(function() {
  window.TmCrawler = {
    ...
    init: function() {
      ...
      if (TmCrawler.Views[viewName] != null) {
        this.currentView = new TmCrawler.Views[viewName]();
      }
      return this.alertView || (this.alertView = new TmCrawler.Views.Alert());
    }
  };

  $(document).on('ready page:load', function() {
    return TmCrawler.init();
  });
...
(function() {
  ...
  TmCrawler.Views.MapBase = (function(_super) {
    __extends(MapBase, _super);

    function MapBase() {
      _ref = MapBase.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    MapBase.prototype.el = '.maps-table';

    MapBase.prototype.events = {
      'ajax:success .map-row-destroy': 'hideAndRemoveMap'
    };

    MapBase.prototype.hideAndRemoveMap = function(e, data, status, xhr) {
      var target;
      target = $(e.currentTarget).closest('tr');
      target.addClass("animated bounceOutRight");
      return target.one('webkitAnimationEnd mozAnimationEnd oAnimationEnd animationEnd', function() {
...
(function() {
  ...
  TmCrawler.Views.MapIndex = (function(_super) {
    __extends(MapIndex, _super);

    function MapIndex() {
      _ref = MapIndex.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    return MapIndex;

  })(TmCrawler.Views.MapBase);
...
(function() {
  ...
  TmCrawler.Views.Alert = (function(_super) {
    ...
    Alert.prototype.initTime = function() {
      var _this = this;
      return setTimeout((function() {
        if (!_this.removed) {
          return _this.AfterTime();
        }
      }), 3500);
    };

    Alert.prototype.ByClick = function(event) {
      event.preventDefault();
      return this.hide($(event.target).closest(".alert"));
    };

    Alert.prototype.AfterTime = function() {
      return this.hide($('.alert-dismissable').closest(".alert"));
    };
...
(function() {
  ...
  TmCrawler.Views.UserShow = (function(_super) {
    __extends(UserShow, _super);

    function UserShow() {
      _ref = UserShow.__super__.constructor.apply(this, arguments);
      return _ref;
    }
